...
// Крафт и спойл (данные из таблицы «Луч КП Дикей»). Соски — главный расход магпака,
// крафтим сами: спойлер (Bounty Hunter) добывает ресурсы, крафтер (Warsmith) делает соски.
export const LU4_CRAFT = {
  intro: 'Соски — главный расход магического пака. Крафтим сами, а не покупаем: спойлер (Bounty Hunter, 10-я позиция) добывает D-Crystal и Soul Ore, крафтер (Warsmith) делает соски. Профит с крафта 19-64% — это доп. казна.',
  recipes: [
    { name: 'Soulshot D — физ', in: '1× D-Crystal + 3× Soul Ore', out: 200, cost: '~5.9 / шт', profit: '~19%' },
    { name: 'Spiritshot D — маг', in: '1× D-Crystal + 3× Soul Ore', out: 140, cost: '~12.2 / шт', profit: '~64%' },
    { name: 'Blessed Spiritshot D — маг', in: '2× D-Crystal + 8× Soul Ore', out: 120, cost: '~36 / шт', profit: '~15%' },
  ],
  spoil: [
    'D-Crystal — ключевой ингредиент сосок и заточек (спойл + дроп)',
    'Soul Ore — основной ингредиент сосок (3-8 шт на крафт)',
    'Ресурсы на сет/пушку — квесты 34-35: Leto Lizardmen (Орен), Gather Ingredients (пасека), Black Swan (Хейн). Мастхев для экипировки.',
  ],
  nukeMath: [
  ...
  tips: [
    'Себестоимость 1 D-соски: физ ~6, маг (Spiritshot) ~12. Рыночная цена выше → крафт в плюс.',
    'Спойл — обязателен: без своих ресурсов одеться и держать соски очень дорого.',
    'Точный расчёт под текущие цены сервера — во вкладке «Крафт».',
  ],
};
