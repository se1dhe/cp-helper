export const RU = {
  ...
  'stash.add': 'Добавить ресурс',
  'stash.search': 'Поиск предмета/ресурса…',
  'stash.target': 'Нужно',
  'stash.addBtn': 'Добавить',
  'stash.hint': 'Отмечай, сколько набил — приложение считает, сколько ещё осталось. Хранится в твоём аккаунте.',
  'stash.empty': 'Пока пусто. Добавь ресурсы, которые копишь.',
  'stash.left': 'Осталось',
  'stash.done': 'Готово',
  'stash.remove': 'Убрать',
  'stash.gathered': 'Набил',
  'stash.spent': 'Убрать (потратил)',
  'cq.coop': 'Складчина',
  'cq.gathered': 'Собрано',
...
export const UA = {
  ...
  'stash.add': 'Додати ресурс',
  'stash.search': 'Пошук предмета/ресурсу…',
  'stash.target': 'Потрібно',
  'stash.addBtn': 'Додати',
  'stash.hint': 'Відмічай, скільки набив — застосунок рахує, скільки ще лишилось. Зберігається у твоєму акаунті.',
  'stash.empty': 'Поки порожньо. Додай ресурси, які збираєш.',
  'stash.left': 'Лишилось',
  'stash.done': 'Готово',
  'stash.remove': 'Прибрати',
  'stash.gathered': 'Набив',
  'stash.spent': 'Прибрати (витратив)',
  'cq.coop': 'Складчина',
  'cq.gathered': 'Зібрано',
