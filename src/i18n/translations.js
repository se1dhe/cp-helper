export const RU = {
  ...
  'win.close': 'Закрыть',
  'quest.walkthrough': 'Прохождение на вики',
  'quest.details': 'Прохождение квеста',
  'quest.intro': 'Описание',
  'quest.startNpc': 'Стартовый NPC',
  'quest.location': 'Локация',
  'quest.rewards': 'Награды',
  'quest.tips': 'Советы',
  'quest.steps': 'Прохождение',
  'quest.openWiki': 'Открыть на l2hub',
  'quest.noDetails': 'Подробное прохождение для этого квеста пока не добавлено. Открой его на l2hub.',
  'craft.tabStash': 'Закладки',
  'craft.toQueue': 'В заявки',
  'craft.toQueueHint': 'Создать заявку пачке на этот предмет',
  'craft.reqSent': 'В заявках',
  'craft.reqError': 'Не удалось создать заявку',
  'craft.toStash': 'В закладки',
  'craft.toStashHint': 'Добавить в личные закладки крафта',
  'craft.bmSent': 'В закладках',
  'stash.add': 'Добавить в закладки',
  'stash.search': 'Что крафтим? Поиск предмета…',
  'stash.addBtn': 'Добавить',
  'stash.count': 'Крафтить, шт',
  'stash.hint': 'Добавь предмет, который хочешь скрафтить, и вписывай, сколько каждого ресурса у тебя уже есть. Приложение покажет, сколько добрать и когда можно крафтить. Хранится в аккаунте.',
  'stash.empty': 'Пока пусто. Добавь предмет, который хочешь скрафтить.',
  'stash.remove': 'Убрать из закладок',
  'stash.need': 'надо',
  'stash.moreNeed': 'ещё {n}',
  'stash.canCraft': 'Можно крафтить!',
  'cq.coop': 'Складчина',
  'cq.gathered': 'Собрано',
  'cq.left': 'осталось',
  'cq.pickRes': 'Выбери ресурс…',
  'cq.qty': 'Кол-во',
  'cq.iSent': 'Я отправил',
  'cq.removeContrib': 'Убрать мой вклад',
  'changelog.title': 'Что нового',
  'changelog.loading': 'Загрузка…',
  'changelog.error': 'Не удалось загрузить список изменений',
  'changelog.none': 'Пока нет опубликованных версий',
  'changelog.all': 'Все релизы на GitHub',
...
export const UA = {
  ...
  'win.close': 'Закрити',
  'quest.walkthrough': 'Проходження на вікі',
  'quest.details': 'Проходження квесту',
  'quest.intro': 'Опис',
  'quest.startNpc': 'Стартовий NPC',
  'quest.location': 'Локація',
  'quest.rewards': 'Нагороди',
  'quest.tips': 'Поради',
  'quest.steps': 'Проходження',
  'quest.openWiki': 'Відкрити на l2hub',
  'quest.noDetails': 'Детальне проходження для цього квесту ще не додано. Відкрий його на l2hub.',
  'craft.tabStash': 'Закладки',
  'craft.toQueue': 'У заявки',
  'craft.toQueueHint': 'Створити заявку пачці на цей предмет',
  'craft.reqSent': 'У заявках',
  'craft.reqError': 'Не вдалося створити заявку',
  'craft.toStash': 'У закладки',
  'craft.toStashHint': 'Додати в особисті закладки крафту',
  'craft.bmSent': 'У закладках',
  'stash.add': 'Додати в закладки',
  'stash.search': 'Що крафтимо? Пошук предмета…',
  'stash.addBtn': 'Додати',
  'stash.count': 'Крафтити, шт',
  'stash.hint': 'Додай предмет, який хочеш скрафтити, і вписуй, скільки кожного ресурсу в тебе вже є. Застосунок покаже, скільки добрати і коли можна крафтити. Зберігається в акаунті.',
  'stash.empty': 'Поки порожньо. Додай предмет, який хочеш скрафтити.',
  'stash.remove': 'Прибрати із закладок',
  'stash.need': 'треба',
  'stash.moreNeed': 'ще {n}',
  'stash.canCraft': 'Можна крафтити!',
  'cq.coop': 'Складчина',
  'cq.gathered': 'Зібрано',
  'cq.left': 'лишилось',
  'cq.pickRes': 'Обери ресурс…',
  'cq.qty': 'К-сть',
  'cq.iSent': 'Я відправив',
  'cq.removeContrib': 'Прибрати мій внесок',
  'changelog.title': 'Що нового',
  'changelog.loading': 'Завантаження…',
  'changelog.error': 'Не вдалося завантажити список змін',
  'changelog.none': 'Поки немає опублікованих версій',
  'changelog.all': 'Усі релізи на GitHub',
